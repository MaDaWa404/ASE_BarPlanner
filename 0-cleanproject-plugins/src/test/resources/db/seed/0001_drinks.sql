...
VALUES ('194df0d2-9d0e-451c-aa6a-a6065a8caf94', 'Marcels Bar', '594df0d2-9d0e-451c-aa6a-a6065a8caf94', '77833', 'Ottersweier', 'Am Laufbach',
        '3');
INSERT INTO bar (id, title, administrator, zip, city, street, number)
VALUES ('cb41dd3b-0922-40c7-8846-ce6a5adb33a0', 'Marcels zweite Bar', '594df0d2-9d0e-451c-aa6a-a6065a8caf94', '76133', 'Karlsruhe', 'Erzbergerstraße',
        '121');
